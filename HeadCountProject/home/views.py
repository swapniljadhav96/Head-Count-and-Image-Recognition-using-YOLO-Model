...
model = YOLO('home/yolov8n-face.pt')

# Load the trained SVM classifier
with open('home/svm_classifier_mega.pkl', 'rb') as f:
    ...
    while cap.isOpened():
        ...
        if success:
            ...
            if bbox != []:
                ...
                cv2.putText(annotated_frame, highest_label, (int(x1)+10, int(y1) - 30), cv2.FONT_HERSHEY_DUPLEX, 0.5, (0, 255, 0), 1)
