...
quadrilateral_coordinates = [(100, 200), (100, 662), (300, 661), (300, 200)]
...
while cap.isOpened():
    ...
    if success:
        ...
        cv2.putText(annotated_frame, f'Out Count: {in_count}', (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
        cv2.putText(annotated_frame, f'In Count: {out_count}', (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
