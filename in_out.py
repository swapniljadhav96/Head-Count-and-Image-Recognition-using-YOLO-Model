...
# Define the two straight liness
line1_x = 400
line2_x = frame_width - 400
        ...
        if bbox != []:
            ...
            if id_values is not None:
                if prev_center_x is not None:
                    if prev_center_x < line2_x and center_x > line2_x:
                        head_count+= 1
                    if prev_center_x > line1_x and center_x < line1_x:
                        head_count-=1
